<div class="flex items-center">
    <div class="w-[50px] m-3 sm:m-5 aspect-square rounded-lg grid place-items-center bg-primary">
    ...
    <div class="hidden sm:flex flex-col">
        @foreach (explode(" ", env('APP_NAME')) as $word)
            <span class="leading-none text-primary poppins-bold uppercase">{{ $word }}</span>
        @endforeach
    </div>
</div>
