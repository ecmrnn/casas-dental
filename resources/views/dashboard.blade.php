<x-app-layout>
    ...
    <div class="grid gap-5 sm:grid-cols-3 sm:gap-10">
        ...
        {{-- Dashboard Content --}}
        <section class="p-5 sm:p-0 w-screen sm:w-full sm:col-span-2">

            {{-- Cards --}}
            <div class="mb-10 gap-2 grid grid-cols-3 xl:gap-10">
                <div class="p-5 flex flex-col xl:flex-row items-center gap-5 rounded-lg border border-gray-200">
                    ...
                    <div>
                        <p class="leading-none text-center xl:text-left text-sm">Total Records</p>
                ...
                <div class="p-5 flex flex-col xl:flex-row items-center gap-5 rounded-lg border border-gray-200">
                    ...
                    <div>
                        <p class="leading-none text-center xl:text-left text-sm">Active Patients</p>
                ...
                <div class="p-5 flex flex-col xl:flex-row items-center gap-5 rounded-lg border border-gray-200">
                    ...
                    <div>
                        <p class="leading-none text-center xl:text-left text-sm">Inactive Patients</p>
            ...
            <div class="p-5 rounded-lg border border-gray-200">
                ...
                <div class="mt-5 overflow-scroll min-h-80">
