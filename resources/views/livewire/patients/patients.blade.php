                ...
                <form autocomplete="off">
                    ...
                    <div class="p-5 space-y-2 border-b border-gray-200 bg-gray-50/90">
                        <div class="py-2 px-3 rounded-lg border border-gray-200 bg-white">
                            ...
                            <x-text-input value="{{ $selectedFirstName }}" wire:model.live.debounce.500ms="selectedFirstName" id="selectedFirstName" class="block w-full focus-visible:outline-none" type="text" name="selectedFirstName" placeholder="Juan" required autofocus autocomplete="username" />
                            <x-input-error :messages="$errors->get('selectedFirstName')" class="mt-2" />
                        </div>
                        <div class="py-2 px-3 rounded-lg border border-gray-200 bg-white">
                            <x-input-label for="selectedLastName" :value="__('Last Name')" />
                            <x-text-input value="{{ $selectedLastName }}" wire:model.live.debounce.500ms="selectedLastName" id="selectedLastName" class="block w-full focus-visible:outline-none" type="text" name="selectedLastName" placeholder="Dela Cruz" required autofocus autocomplete="lastName" />
                        ...
                        <div class="py-2 px-3 rounded-lg border border-gray-200 bg-white">
                            ...
                            <x-text-input value="{{ $selectedAddress }}" wire:model.live.debounce.500ms="selectedAddress" id="selectedAddress" class="block w-full focus-visible:outline-none" type="text" name="selectedLastName" placeholder="Patient Address (Optional)" required autofocus autocomplete="lastName" />
