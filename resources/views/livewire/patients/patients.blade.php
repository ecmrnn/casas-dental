    ...
    <section class="p-5 mt-5 md:rounded-lg border border-b-0 md:border-b border-gray-200 bg-white">
        ...
        @else
            ...
            <div class="hidden md:block mt-5">
                <x-table>
                    <x-slot name="header">
                        <th class="pl-5 py-3 text-left bg-primary/10 rounded-s-lg"></th>
                        ...
                        @foreach ($patients as $patient)
                            <tr key="{{ $patient->id }}">
                                <td class="pl-2 border-y border-l rounded-s-lg border-gray-200">
                                    <a href="/" class="w-[50px] h-[40px] grid place-items-center rounded-lg border border-gray-200 hover:bg-gray-50 transition-all ease-in-out duration-200">
